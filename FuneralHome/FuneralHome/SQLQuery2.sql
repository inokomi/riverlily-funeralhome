...
create table tblDecedent(ID int identity,Family varchar(50), First varchar(50), Middle varchar(50),Birthdate varchar(50),Deathdate varchar(50),Room varchar(50),Service varchar(50), DecedentID varchar(10))
...
ALTER TABLE tblDecedent DecedentID varchar(10)
drop table tblDecedent
