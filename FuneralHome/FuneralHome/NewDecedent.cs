...
{
    public partial class NewDecedent : Form
    {
        public NewDecedent()
        {
            InitializeComponent();
        ...
        private void NewDecedent_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            connection.Open();
            string queryStr = "INSERT INTO tblDecedent(Family, First, Middle, Birthdate, Deathdate, Room, Service, DecedentID) VALUES(@Family,@First,@Middle,@Birthdate,@Deathdate,@Room,@Service,@DecedentID);";
            var command = new SqlCommand(queryStr,connection);
            ...
            textBox1.Text = textBox2.Text = textBox3.Text = textBox4.Text = dateTimePicker1.Text = dateTimePicker2.Text = comboBox1.Text = comboBox2.Text = string.Empty;
            MessageBox.Show("Decedent Information has been recorded!", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
    }
}
